...
type MsgSell_Order struct {
	...
	// expiration is the datetime that the sell order will expire.
...
func (m *MsgSell_Order) GetExpiration() string {
	if m != nil {
		return m.Expiration
	}
	return ""
...
type MsgUpdateSellOrders_Update struct {
	...
	// new_expiration is the new datetime that the sell order will expire.
	NewExpiration string `protobuf:"bytes,4,opt,name=new_expiration,json=newExpiration,proto3" json:"new_expiration,omitempty"`
...
func (m *MsgUpdateSellOrders_Update) GetNewExpiration() string {
	if m != nil {
...
type MsgBuy_Order struct {
	...
	// expiration is the datetime that the buy order will expire.
	Expiration string `protobuf:"bytes,4,opt,name=expiration,proto3" json:"expiration,omitempty"`
...
func (m *MsgBuy_Order) GetExpiration() string {
	if m != nil {
		return m.Expiration
	}
	return ""
...
var fileDescriptor_e82815fbf9298ddc = []byte{
	...
	,
}
...
func (m *MsgUpdateSellOrders_Update) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NewExpiration) > 0 {
		i -= len(m.NewExpiration)
		copy(dAtA[i:], m.NewExpiration)
		i = encodeVarintTx(dAtA, i, uint64(len(m.NewExpiration)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *MsgUpdateSellOrders_Update) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.NewExpiration = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableAutoRetire", wireType)
